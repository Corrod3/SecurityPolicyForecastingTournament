...
A second and more intutive measurement of the overall forecasting accuracy of the participants is the proportion of questions where  forecasters with their forecasts were on the correct side of 50%  [@Mellers.2015, p. 6]. The measure counts the forecasts above 50% for event which happened and forecasts below 50% for events which did not happen and divides them by the total number of forecasts. The perfect score would be 100%, a score corresponding to chance 50%. The forecasting average of the tournament participants was `r round(mean(SB.CS$cs.avg)*100, 1)`%. Again, we can use the t-test to measure the significance of the difference to the chance score (`r t.test.correct.side`).

<!-- [evaluation] --> 
Like for the first benchmark, this measurement indicates that forecasters performed better than random guessing. However, it does also illustrate that on average the forecasters are just slightly better than chance. For comparison: In the Good Judgement Project [@Mellers.2015, p. 6] forecasting competition the share was 75%, indicating that their forecasters crowd performed better.^[A third measure for the overall performance of the crowd would be to compare their average score to a 50% guess for each question, which would basically be a coin flip. A 50% guess for each question would have resulted in a Brier score of 0.5. Hence, according to this measurement the crowd actually performed worse than a simple 50% guessing strategy. From this point of view the crow performance looks less favourable than with the other to measures. For this research, this is not so dramatic as the primary focus is not on the crowd performance but on understanding why some individuals outperformed the crowd. The third measure is less prominently discussed here, because I followed the convention of @Mellers.2015, who only discussed the other two measurement.]  <!-- check all of this after 24.04.-->
