...
But even if the forecasters used the decision methodology, the lack of higher accuracy might also steam from irrelevancy of the proposed methodology. However, this would contradict the research results by @Tetlock.2015 and his so-called superforecasters, who performed rather well with the methodology of the decision guide in the Good Judgement Project. Nevertheless, the problem might by a result of inappropiate application of the decision heuristic. In other words: In order to show measurable results in terms of forecasting accuracy the forecasters need succicient training in the methodology and a simple decision guide just does not provided enough learning experience. This is the most plausible explanation for the intervention failure, as for example @Mellers.2014 showed how a one-hour probabilistic training, which included the inside outside view methodology, could improve forecasting accuracy on the long term.
